...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapIdentityEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        var emailSender = endpoints.ServiceProvider.GetRequiredService<IEmailSender<ApplicationIdentityUser>>();
        var linkGenerator = endpoints.ServiceProvider.GetRequiredService<LinkGenerator>();

        // We'll figure out a unique endpoint name based on the final route pattern during endpoint generation.
        string? confirmEmailEndpointName = null;

        var routeGroup = endpoints.MapGroup("Authentication");
            ...
            ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            var userStore = sp.GetRequiredService<IUserStore<ApplicationIdentityUser>>();
            var emailStore = (IUserEmailStore<ApplicationIdentityUser>)userStore;
        ...
        {
            var signInManager = sp.GetRequiredService<IdentitySignInManager>();
        ...
        routeGroup.MapPost("/refresh", async Task<Results<Ok<AccessTokenResponse>, UnauthorizedHttpResult, BadRequest<string>>>
            ([FromBody] RefreshRequest refreshRequest, [FromServices] IServiceProvider sp) =>
        {
            ...
            var tokenResponse = await signInManager.RefreshTokenAsync(refreshRequest.RefreshToken);
        ...
        async Task SendConfirmationEmailAsync(ApplicationIdentityUser user, IdentityUserManager userManager, HttpContext context, string email, bool isChange = false)
        {
